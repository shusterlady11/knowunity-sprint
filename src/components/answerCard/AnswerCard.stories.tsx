...
**Differences from Figma, by decision:** "Thinking..." uses \`text/secondary\` alone (Figma adds an extra 68% opacity, which falls under the 4.5:1 contrast minimum). The skeleton bars are \`Space/300\` (12px) tall (Figma: 14px, no token), filled with \`interactive/secondary\` alone (Figma adds an extra 10% opacity), 100%, 88% and 60% of the card wide, and one \`font/lineHeight/md\` (24px) apart.`;
